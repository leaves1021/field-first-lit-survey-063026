...
- 这种 widespread evidence encoding and integration 在 trained vs untrained 对比中更明显：untrained mice 的 TF-responsive cells 主要局限于视觉系统和少数 midbrain 区域，而非训练后的广泛 premotor / subcortical 分布。
